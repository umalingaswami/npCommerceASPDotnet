---
title: Resolving the current customer context
---
This document describes how the platform identifies the current customer for each request, supporting both user and system interactions. By resolving the customer context, the system enables personalized experiences and ensures correct access control for every part of the eCommerce journey.

The main steps are:

- Retrieve or resolve the customer context
- Distinguish between system, bot, and user requests
- Authenticate and validate the user
- Handle impersonation and guest fallback
- Finalize and store the customer context for the session
...
f2c578c3046d746c730cf8b4343706207966fb3abf9836ee7eeedae8b285b2ae(src/…/Controllers/CheckoutController.cs::CheckoutController.OpcSaveBilling) --> a902294af30dbf1686c2a32d9c064c103229d84af02998e3f0d7c2d21689d4d4(src/…/Controllers/CheckoutController.cs::CheckoutController.OpcLoadStepAfterShippingMethod)

f2c578c3046d746c730cf8b4343706207966fb3abf9836ee7eeedae8b285b2ae(src/…/Controllers/CheckoutController.cs::CheckoutController.OpcSaveBilling) --> 4494d255b06581f70a9c3a8bb28efa7a92c4844df9d001eaff3b8d9cd7318b12(src/…/Factories/CheckoutModelFactory.cs::CheckoutModelFactory.PrepareShippingAddressModelAsync)

f2c578c3046d746c730cf8b4343706207966fb3abf9836ee7eeedae8b285b2ae(src/…/Controllers/CheckoutController.cs::CheckoutController.OpcSaveBilling) --> 1404150abbe1dd624c7283bb90aad041f71b99c0503a5a91ecf1ecd9dfe1a340(src/…/Factories/CheckoutModelFactory.cs::CheckoutModelFactory.PrepareBillingAddressModelAsync)

f2c578c3046d746c730cf8b4343706207966fb3abf9836ee7eeedae8b285b2ae(src/…/Controllers/CheckoutController.cs::CheckoutController.OpcSaveBilling) --> 673a8f898eb7f79856efaf53f3ce4128c7466231fde11a2bf69fbc7ef06ab422(src/…/Common/AddressAttributeParser.cs::AddressAttributeParser.GetAttributeWarningsAsync)

f2c578c3046d746c730cf8b4343706207966fb3abf9836ee7eeedae8b285b2ae(src/…/Controllers/CheckoutController.cs::CheckoutController.OpcSaveBilling) --> baac9bcc81ef44dba47d694d6807bdc8fe3ab78e3e82b1d9c4ba73cfbcbf07c7(src/…/Localization/LocalizationService.cs::LocalizationService.GetResourceAsync)

f2c578c3046d746c730cf8b4343706207966fb3abf9836ee7eeedae8b285b2ae(src/…/Controllers/CheckoutController.cs::CheckoutController.OpcSaveBilling) --> f9ae54b01c887680cf1f40c245c87d9fdaafc202dd22a5134d34e9a7e3710386(src/…/Nop.Web.Framework/WebWorkContext.cs::WebWorkContext.GetCurrentCustomerAsync)

1404150abbe1dd624c7283bb90aad041f71b99c0503a5a91ecf1ecd9dfe1a340(src/…/Factories/CheckoutModelFactory.cs::CheckoutModelFactory.PrepareBillingAddressModelAsync) --> 8a51c21977702e2b626e654cb1e9528f4fa363324af5cb3c506d3a6a2bed9f3c(src/…/Factories/AddressModelFactory.cs::AddressModelFactory.PrepareAddressModelAsync)

1404150abbe1dd624c7283bb90aad041f71b99c0503a5a91ecf1ecd9dfe1a340(src/…/Factories/CheckoutModelFactory.cs::CheckoutModelFactory.PrepareBillingAddressModelAsync) --> 01e725abc0f425fc86137c4bf0c683c786655cfd96be032844f46f8cce33d3a7(src/…/Directory/CountryService.cs::CountryService.GetAllCountriesForBillingAsync)

1404150abbe1dd624c7283bb90aad041f71b99c0503a5a91ecf1ecd9dfe1a340(src/…/Factories/CheckoutModelFactory.cs::CheckoutModelFactory.PrepareBillingAddressModelAsync) --> d2ecaad7ee40f6e238f5ba57c6c32f47c4f982746a411da16e0c1ca6819ac5ac(src/…/Common/AddressService.cs::AddressService.IsAddressValidAsync)

1404150abbe1dd624c7283bb90aad041f71b99c0503a5a91ecf1ecd9dfe1a340(src/…/Factories/CheckoutModelFactory.cs::CheckoutModelFactory.PrepareBillingAddressModelAsync) --> 55e38835199440710d1a4dd3845ecf28376777ce813071f48bcc57b6d6048e91(src/…/Nop.Web.Framework/WebWorkContext.cs::WebWorkContext.GetWorkingLanguageAsync)

1404150abbe1dd624c7283bb90aad041f71b99c0503a5a91ecf1ecd9dfe1a340(src/…/Factories/CheckoutModelFactory.cs::CheckoutModelFactory.PrepareBillingAddressModelAsync) --> f9ae54b01c887680cf1f40c245c87d9fdaafc202dd22a5134d34e9a7e3710386(src/…/Nop.Web.Framework/WebWorkContext.cs::WebWorkContext.GetCurrentCustomerAsync)

01e725abc0f425fc86137c4bf0c683c786655cfd96be032844f46f8cce33d3a7(src/…/Directory/CountryService.cs::CountryService.GetAllCountriesForBillingAsync) --> 60ec5478e2412e04027d8d7e068594f3e2bb49d23e91413d6615ff1a4c0a738c(src/…/Directory/CountryService.cs::CountryService.GetAllCountriesAsync)
...
%% 
%% f2c578c3046d746c730cf8b4343706207966fb3abf9836ee7eeedae8b285b2ae(<SwmPath>[src/…/Controllers/CheckoutController.cs](src/Presentation/Nop.Web/Controllers/CheckoutController.cs)</SwmPath>::CheckoutController.OpcSaveBilling) --> a902294af30dbf1686c2a32d9c064c103229d84af02998e3f0d7c2d21689d4d4(<SwmPath>[src/…/Controllers/CheckoutController.cs](src/Presentation/Nop.Web/Controllers/CheckoutController.cs)</SwmPath>::CheckoutController.OpcLoadStepAfterShippingMethod)
%% 
%% f2c578c3046d746c730cf8b4343706207966fb3abf9836ee7eeedae8b285b2ae(<SwmPath>[src/…/Controllers/CheckoutController.cs](src/Presentation/Nop.Web/Controllers/CheckoutController.cs)</SwmPath>::CheckoutController.OpcSaveBilling) --> 4494d255b06581f70a9c3a8bb28efa7a92c4844df9d001eaff3b8d9cd7318b12(<SwmPath>[src/…/Factories/CheckoutModelFactory.cs](src/Presentation/Nop.Web/Factories/CheckoutModelFactory.cs)</SwmPath>::CheckoutModelFactory.PrepareShippingAddressModelAsync)
%% 
%% f2c578c3046d746c730cf8b4343706207966fb3abf9836ee7eeedae8b285b2ae(<SwmPath>[src/…/Controllers/CheckoutController.cs](src/Presentation/Nop.Web/Controllers/CheckoutController.cs)</SwmPath>::CheckoutController.OpcSaveBilling) --> 1404150abbe1dd624c7283bb90aad041f71b99c0503a5a91ecf1ecd9dfe1a340(<SwmPath>[src/…/Factories/CheckoutModelFactory.cs](src/Presentation/Nop.Web/Factories/CheckoutModelFactory.cs)</SwmPath>::CheckoutModelFactory.PrepareBillingAddressModelAsync)
%% 
%% f2c578c3046d746c730cf8b4343706207966fb3abf9836ee7eeedae8b285b2ae(<SwmPath>[src/…/Controllers/CheckoutController.cs](src/Presentation/Nop.Web/Controllers/CheckoutController.cs)</SwmPath>::CheckoutController.OpcSaveBilling) --> 673a8f898eb7f79856efaf53f3ce4128c7466231fde11a2bf69fbc7ef06ab422(<SwmPath>[src/…/Common/AddressAttributeParser.cs](src/Libraries/Nop.Services/Common/AddressAttributeParser.cs)</SwmPath>::AddressAttributeParser.GetAttributeWarningsAsync)
%% 
%% f2c578c3046d746c730cf8b4343706207966fb3abf9836ee7eeedae8b285b2ae(<SwmPath>[src/…/Controllers/CheckoutController.cs](src/Presentation/Nop.Web/Controllers/CheckoutController.cs)</SwmPath>::CheckoutController.OpcSaveBilling) --> baac9bcc81ef44dba47d694d6807bdc8fe3ab78e3e82b1d9c4ba73cfbcbf07c7(<SwmPath>[src/…/Localization/LocalizationService.cs](src/Libraries/Nop.Services/Localization/LocalizationService.cs)</SwmPath>::LocalizationService.GetResourceAsync)
%% 
%% f2c578c3046d746c730cf8b4343706207966fb3abf9836ee7eeedae8b285b2ae(<SwmPath>[src/…/Controllers/CheckoutController.cs](src/Presentation/Nop.Web/Controllers/CheckoutController.cs)</SwmPath>::CheckoutController.OpcSaveBilling) --> f9ae54b01c887680cf1f40c245c87d9fdaafc202dd22a5134d34e9a7e3710386(<SwmPath>[src/…/Nop.Web.Framework/WebWorkContext.cs](src/Presentation/Nop.Web.Framework/WebWorkContext.cs)</SwmPath>::WebWorkContext.GetCurrentCustomerAsync)
%% 
%% 1404150abbe1dd624c7283bb90aad041f71b99c0503a5a91ecf1ecd9dfe1a340(<SwmPath>[src/…/Factories/CheckoutModelFactory.cs](src/Presentation/Nop.Web/Factories/CheckoutModelFactory.cs)</SwmPath>::CheckoutModelFactory.PrepareBillingAddressModelAsync) --> 8a51c21977702e2b626e654cb1e9528f4fa363324af5cb3c506d3a6a2bed9f3c(<SwmPath>[src/…/Factories/AddressModelFactory.cs](src/Presentation/Nop.Web/Areas/Admin/Factories/AddressModelFactory.cs)</SwmPath>::AddressModelFactory.PrepareAddressModelAsync)
%% 
%% 1404150abbe1dd624c7283bb90aad041f71b99c0503a5a91ecf1ecd9dfe1a340(<SwmPath>[src/…/Factories/CheckoutModelFactory.cs](src/Presentation/Nop.Web/Factories/CheckoutModelFactory.cs)</SwmPath>::CheckoutModelFactory.PrepareBillingAddressModelAsync) --> 01e725abc0f425fc86137c4bf0c683c786655cfd96be032844f46f8cce33d3a7(<SwmPath>[src/…/Directory/CountryService.cs](src/Libraries/Nop.Services/Directory/CountryService.cs)</SwmPath>::CountryService.GetAllCountriesForBillingAsync)
%% 
%% 1404150abbe1dd624c7283bb90aad041f71b99c0503a5a91ecf1ecd9dfe1a340(<SwmPath>[src/…/Factories/CheckoutModelFactory.cs](src/Presentation/Nop.Web/Factories/CheckoutModelFactory.cs)</SwmPath>::CheckoutModelFactory.PrepareBillingAddressModelAsync) --> d2ecaad7ee40f6e238f5ba57c6c32f47c4f982746a411da16e0c1ca6819ac5ac(<SwmPath>[src/…/Common/AddressService.cs](src/Libraries/Nop.Services/Common/AddressService.cs)</SwmPath>::AddressService.IsAddressValidAsync)
%% 
%% 1404150abbe1dd624c7283bb90aad041f71b99c0503a5a91ecf1ecd9dfe1a340(<SwmPath>[src/…/Factories/CheckoutModelFactory.cs](src/Presentation/Nop.Web/Factories/CheckoutModelFactory.cs)</SwmPath>::CheckoutModelFactory.PrepareBillingAddressModelAsync) --> 55e38835199440710d1a4dd3845ecf28376777ce813071f48bcc57b6d6048e91(<SwmPath>[src/…/Nop.Web.Framework/WebWorkContext.cs](src/Presentation/Nop.Web.Framework/WebWorkContext.cs)</SwmPath>::WebWorkContext.GetWorkingLanguageAsync)
%% 
%% 1404150abbe1dd624c7283bb90aad041f71b99c0503a5a91ecf1ecd9dfe1a340(<SwmPath>[src/…/Factories/CheckoutModelFactory.cs](src/Presentation/Nop.Web/Factories/CheckoutModelFactory.cs)</SwmPath>::CheckoutModelFactory.PrepareBillingAddressModelAsync) --> f9ae54b01c887680cf1f40c245c87d9fdaafc202dd22a5134d34e9a7e3710386(<SwmPath>[src/…/Nop.Web.Framework/WebWorkContext.cs](src/Presentation/Nop.Web.Framework/WebWorkContext.cs)</SwmPath>::WebWorkContext.GetCurrentCustomerAsync)
%% 
%% 01e725abc0f425fc86137c4bf0c683c786655cfd96be032844f46f8cce33d3a7(<SwmPath>[src/…/Directory/CountryService.cs](src/Libraries/Nop.Services/Directory/CountryService.cs)</SwmPath>::CountryService.GetAllCountriesForBillingAsync) --> 60ec5478e2412e04027d8d7e068594f3e2bb49d23e91413d6615ff1a4c0a738c(<SwmPath>[src/…/Directory/CountryService.cs](src/Libraries/Nop.Services/Directory/CountryService.cs)</SwmPath>::CountryService.GetAllCountriesAsync)
%% 
%% 
%% classDef mainFlowStyle color:#000000,fill:#7CB9F4
%% classDef rootsStyle color:#000000,fill:#00FFF4
...
flowchart TD
    node1["Start: Get current customer"] --> node2{"Is cached customer available?"}
    click node1 openCode "src/Presentation/Nop.Web.Framework/WebWorkContext.cs:199:200"
    node2 -->|"Yes"| node3["Return cached customer"]
...
<SwmToken path="src/Presentation/Nop.Web.Framework/WebWorkContext.cs" pos="199:12:12" line-data="        public virtual async Task&lt;Customer&gt; GetCurrentCustomerAsync()">`GetCurrentCustomerAsync`</SwmToken> checks for a cached customer and, if missing, triggers the process to resolve and cache the current customer.
...
# Determining the Customer Context

<SwmSnippet path="/src/Presentation/Nop.Web.Framework/WebWorkContext.cs" line="215">

---

In <SwmToken path="src/Presentation/Nop.Web.Framework/WebWorkContext.cs" pos="215:9:9" line-data="        public virtual async Task SetCurrentCustomerAsync(Customer customer = null)">`SetCurrentCustomerAsync`</SwmToken>, we start by figuring out what kind of request we're dealing with—background task, search engine, or actual user. If it's not a system or bot, we call the authentication service to try and get a real user. This step is needed to make sure we're not mixing up system traffic with actual customers.
...
In <SwmToken path="src/Libraries/Nop.Services/Authentication/CookieAuthenticationService.cs" pos="100:12:12" line-data="        public virtual async Task&lt;Customer&gt; GetAuthenticatedCustomerAsync()">`GetAuthenticatedCustomerAsync`</SwmToken>, we first check if we've already got a cached authenticated user. If not, we use the HTTP context to try and authenticate the request using the platform's configured scheme. If that doesn't work, we bail out and return null, otherwise we move on to external authentication if needed.
...
See <SwmLink doc-title="External Authentication and Registration Flow">[External Authentication and Registration Flow](.swm%5Cexternal-authentication-and-registration-flow.9j4n4van.sw.md)</SwmLink>
...
flowchart TD
    ...
    node1 --> node2{"Is authentication by username enabled?"}
    click node2 openCode "src/Libraries/Nop.Services/Authentication/CookieAuthenticationService.cs:112:113"
    node2 -->|"Yes"| node3{"Is username claim present?"}
    click node3 openCode "src/Libraries/Nop.Services/Authentication/CookieAuthenticationService.cs:115:118"
    node2 -->|"No"| node4{"Is email claim present?"}
    click node4 openCode "src/Libraries/Nop.Services/Authentication/CookieAuthenticationService.cs:123:126"
    node3 -->|"Yes"| node5["Identify customer by username"]
    click node5 openCode "src/Libraries/Nop.Services/Authentication/CookieAuthenticationService.cs:118:119"
    node3 -->|"No"| node8["No authenticated customer"]
    click node8 openCode "src/Libraries/Nop.Services/Authentication/CookieAuthenticationService.cs:131:132"
    node4 -->|"Yes"| node6["Identify customer by email"]
    click node6 openCode "src/Libraries/Nop.Services/Authentication/CookieAuthenticationService.cs:126:127"
    node4 -->|"No"| node8
    node5 --> node7{"Is customer valid (active, not deleted, not requiring re-login, registered)?"}
    click node7 openCode "src/Libraries/Nop.Services/Authentication/CookieAuthenticationService.cs:130:131"
    node6 --> node7
    node7 -->|"Yes"| node9["Cache and return authenticated customer"]
    click node9 openCode "src/Libraries/Nop.Services/Authentication/CookieAuthenticationService.cs:134:137"
    node7 -->|"No"| node8
classDef HeadingStyle fill:#777777,stroke:#333,stroke-width:2px;
...
%%     node1 --> node2{"Is authentication by username enabled?"}
%%     click node2 openCode "<SwmPath>[src/…/Authentication/CookieAuthenticationService.cs](src/Libraries/Nop.Services/Authentication/CookieAuthenticationService.cs)</SwmPath>:112:113"
%%     node2 -->|"Yes"| node3{"Is username claim present?"}
%%     click node3 openCode "<SwmPath>[src/…/Authentication/CookieAuthenticationService.cs](src/Libraries/Nop.Services/Authentication/CookieAuthenticationService.cs)</SwmPath>:115:118"
%%     node2 -->|"No"| node4{"Is email claim present?"}
%%     click node4 openCode "<SwmPath>[src/…/Authentication/CookieAuthenticationService.cs](src/Libraries/Nop.Services/Authentication/CookieAuthenticationService.cs)</SwmPath>:123:126"
%%     node3 -->|"Yes"| node5["Identify customer by username"]
%%     click node5 openCode "<SwmPath>[src/…/Authentication/CookieAuthenticationService.cs](src/Libraries/Nop.Services/Authentication/CookieAuthenticationService.cs)</SwmPath>:118:119"
%%     node3 -->|"No"| node8["No authenticated customer"]
%%     click node8 openCode "<SwmPath>[src/…/Authentication/CookieAuthenticationService.cs](src/Libraries/Nop.Services/Authentication/CookieAuthenticationService.cs)</SwmPath>:131:132"
%%     node4 -->|"Yes"| node6["Identify customer by email"]
%%     click node6 openCode "<SwmPath>[src/…/Authentication/CookieAuthenticationService.cs](src/Libraries/Nop.Services/Authentication/CookieAuthenticationService.cs)</SwmPath>:126:127"
%%     node4 -->|"No"| node8
%%     node5 --> node7{"Is customer valid (active, not deleted, not requiring re-login, registered)?"}
%%     click node7 openCode "<SwmPath>[src/…/Authentication/CookieAuthenticationService.cs](src/Libraries/Nop.Services/Authentication/CookieAuthenticationService.cs)</SwmPath>:130:131"
%%     node6 --> node7
%%     node7 -->|"Yes"| node9["Cache and return authenticated customer"]
%%     click node9 openCode "<SwmPath>[src/…/Authentication/CookieAuthenticationService.cs](src/Libraries/Nop.Services/Authentication/CookieAuthenticationService.cs)</SwmPath>:134:137"
%%     node7 -->|"No"| node8
%% classDef HeadingStyle fill:#777777,stroke:#333,stroke-width:2px;
```
...
Back in <SwmToken path="src/Presentation/Nop.Web.Framework/WebWorkContext.cs" pos="238:9:9" line-data="                    customer = await _authenticationService.GetAuthenticatedCustomerAsync();">`GetAuthenticatedCustomerAsync`</SwmToken>, after external authentication, we pull the username or email from the claims (depending on settings), look up the customer, and run a bunch of checks to make sure they're legit. If everything passes, we cache the customer for next time.
...
## Finalizing the Customer Context

```mermaid
%%{init: {"flowchart": {"defaultRenderer": "elk"}} }%%
flowchart TD
    node1["Start: Provided customer"] --> node2{"Is customer valid? (Active, Not Deleted, No Re-login)"}
    click node1 openCode "src/Presentation/Nop.Web.Framework/WebWorkContext.cs:241:242"
    click node2 openCode "src/Presentation/Nop.Web.Framework/WebWorkContext.cs:241:242"
    node2 -->|"Valid"| node3{"Does customer need impersonation?"}
    click node3 openCode "src/Presentation/Nop.Web.Framework/WebWorkContext.cs:244:246"
    node3 -->|"Yes"| node4["Set impersonated customer"]
    ...
    node5 -->|"Valid"| node6["Use impersonated customer"]
    click node6 openCode "src/Presentation/Nop.Web.Framework/WebWorkContext.cs:255:256"
    node5 -->|"Invalid"| node7["Proceed to guest fallback"]
    node3 -->|"No"| node6
    node2 -->|"Invalid"| node7["Proceed to guest fallback"]
    node6 --> node8{"Is customer valid?"}
    click node8 openCode "src/Presentation/Nop.Web.Framework/WebWorkContext.cs:273:274"
    node7 --> node9{"Is guest customer from cookie valid?"}
    click node9 openCode "src/Presentation/Nop.Web.Framework/WebWorkContext.cs:263:270"
    node9 -->|"Valid"| node10["Use guest customer from cookie"]
    click node10 openCode "src/Presentation/Nop.Web.Framework/WebWorkContext.cs:269:270"
    node9 -->|"Invalid"| node11["Create new guest customer"]
    click node11 openCode "src/Presentation/Nop.Web.Framework/WebWorkContext.cs:276:277"
    node10 --> node8
    node11 --> node8
    node8 -->|"Valid"| node12["Set customer cookie and cache customer"]
    click node12 openCode "src/Presentation/Nop.Web.Framework/WebWorkContext.cs:283:287"
    node8 -->|"Invalid"| node11
classDef HeadingStyle fill:#777777,stroke:#333,stroke-width:2px;
...
%% flowchart TD
%%     node1["Start: Provided customer"] --> node2{"Is customer valid? (Active, Not Deleted, No Re-login)"}
%%     click node1 openCode "<SwmPath>[src/…/Nop.Web.Framework/WebWorkContext.cs](src/Presentation/Nop.Web.Framework/WebWorkContext.cs)</SwmPath>:241:242"
...
%%     node2 -->|"Valid"| node3{"Does customer need impersonation?"}
%%     click node3 openCode "<SwmPath>[src/…/Nop.Web.Framework/WebWorkContext.cs](src/Presentation/Nop.Web.Framework/WebWorkContext.cs)</SwmPath>:244:246"
%%     node3 -->|"Yes"| node4["Set impersonated customer"]
...
%%     node5 -->|"Valid"| node6["Use impersonated customer"]
%%     click node6 openCode "<SwmPath>[src/…/Nop.Web.Framework/WebWorkContext.cs](src/Presentation/Nop.Web.Framework/WebWorkContext.cs)</SwmPath>:255:256"
%%     node5 -->|"Invalid"| node7["Proceed to guest fallback"]
%%     node3 -->|"No"| node6
%%     node2 -->|"Invalid"| node7["Proceed to guest fallback"]
%%     node6 --> node8{"Is customer valid?"}
%%     click node8 openCode "<SwmPath>[src/…/Nop.Web.Framework/WebWorkContext.cs](src/Presentation/Nop.Web.Framework/WebWorkContext.cs)</SwmPath>:273:274"
%%     node7 --> node9{"Is guest customer from cookie valid?"}
%%     click node9 openCode "<SwmPath>[src/…/Nop.Web.Framework/WebWorkContext.cs](src/Presentation/Nop.Web.Framework/WebWorkContext.cs)</SwmPath>:263:270"
%%     node9 -->|"Valid"| node10["Use guest customer from cookie"]
%%     click node10 openCode "<SwmPath>[src/…/Nop.Web.Framework/WebWorkContext.cs](src/Presentation/Nop.Web.Framework/WebWorkContext.cs)</SwmPath>:269:270"
%%     node9 -->|"Invalid"| node11["Create new guest customer"]
%%     click node11 openCode "<SwmPath>[src/…/Nop.Web.Framework/WebWorkContext.cs](src/Presentation/Nop.Web.Framework/WebWorkContext.cs)</SwmPath>:276:277"
%%     node10 --> node8
%%     node11 --> node8
%%     node8 -->|"Valid"| node12["Set customer cookie and cache customer"]
%%     click node12 openCode "<SwmPath>[src/…/Nop.Web.Framework/WebWorkContext.cs](src/Presentation/Nop.Web.Framework/WebWorkContext.cs)</SwmPath>:283:287"
%%     node8 -->|"Invalid"| node11
%% classDef HeadingStyle fill:#777777,stroke:#333,stroke-width:2px;
```
...
After coming back from <SwmToken path="src/Presentation/Nop.Web.Framework/WebWorkContext.cs" pos="238:9:9" line-data="                    customer = await _authenticationService.GetAuthenticatedCustomerAsync();">`GetAuthenticatedCustomerAsync`</SwmToken>, <SwmToken path="src/Presentation/Nop.Web.Framework/WebWorkContext.cs" pos="205:3:3" line-data="            await SetCurrentCustomerAsync();">`SetCurrentCustomerAsync`</SwmToken> checks if the user should be impersonated, tries to resolve a guest from cookies if needed, and creates a new guest if all else fails. Once a valid customer is found, it sets the cookie and caches the customer for the rest of the request.
